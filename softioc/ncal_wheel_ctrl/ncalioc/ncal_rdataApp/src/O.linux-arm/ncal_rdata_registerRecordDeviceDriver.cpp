...
/* Generated from ../O.Common/ncal_rdata.dbd */
...
int ncal_rdata_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/home/controls/Documents/ncal_wheel_ctrl/ncalioc";
...
/* ncal_rdata_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"ncal_rdata_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    ncal_rdata_registerRecordDeviceDriver(*iocshPpdbbase);
}
