...
/* Generated from ../O.Common/ncal_response.dbd */
...
int ncal_response_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/home/controls/Documents/gravforcecal/arduino/ncal_response/ncalioc";
...
/* ncal_response_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"ncal_response_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    ncal_response_registerRecordDeviceDriver(*iocshPpdbbase);
}
